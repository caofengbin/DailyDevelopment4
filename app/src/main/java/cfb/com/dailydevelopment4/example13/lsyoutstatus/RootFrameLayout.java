...
public class RootFrameLayout extends FrameLayout {
    ...
    private void addAllLayoutToRootLayout() {
        ...
        if (mStatusLayoutManager.emptyDataViewStub != null) {
            addView(mStatusLayoutManager.emptyDataViewStub);
        }
        if (mStatusLayoutManager.errorViewStub != null) {
            addView(mStatusLayoutManager.errorViewStub);
        }
        if (mStatusLayoutManager.netWorkErrorViewStub != null) {
            addView(mStatusLayoutManager.netWorkErrorViewStub);
        }
    }
    ...
    private boolean inflateLayout(int id) {
        ...
        switch (id) {
            case LAYOUT_NETWORK_ERROR_ID:
                if (mStatusLayoutManager.netWorkErrorViewStub != null) {
                    View view = mStatusLayoutManager.netWorkErrorViewStub.inflate();
            ...
            case LAYOUT_ERROR_ID:
                if (mStatusLayoutManager.errorViewStub != null) {
                    View view = mStatusLayoutManager.errorViewStub.inflate();
            ...
            case LAYOUT_EMPTYDATA_ID:
                if (mStatusLayoutManager.emptyDataViewStub != null) {
                    View view = mStatusLayoutManager.emptyDataViewStub.inflate();
