...
public class BarTPChartRender extends TPChartRender {

    private IBarDataI barData;
    ...
    public BarTPChartRender(IBarDataI barData, IXAxisData xAxisData, IYAxisData yAxisData, float offset, float barWidth) {
        super();
